...
const Services = () => {
    return (
        ...
        <section className="w-full h-full md:min-h-[300px] py-20 bg-gradient-to-l from-[#F2FF5F] to-white flex-col justify-center items-center inline-flex">
            <h2 className="text-center text-blue-950 text-4xl font-semibold font-['Poppins'] pb-10">Services</h2>
            <div className="flex-col justify-center items-center gap-10 grid grid-flow-cols-1 md:grid-cols-2">   
                ...
                <h3 className="text-center text-white text-2xl font-normal font-['Poppins'] py-5">Careers</h3>
                <Accordion type="single" collapsible className="w-full max-w-[350px] xl:max-w-[600px] px-5 text-white text-sm sm:text-sm md:text-md lg:text-lg font-extralight text-start font-['Poppins'] ">
                ...
                <h3 className="text-center text-white text-2xl font-normal font-['Poppins'] py-5">Entrepreneur</h3>
                <Accordion type="single" collapsible className="w-full max-w-[350px] xl:max-w-[600px] px-5 text-white text-sm sm:text-sm md:text-md lg:text-lg font-extralight font-['Poppins'] open:text-yellow-300">
