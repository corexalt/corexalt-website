      ...
      <div className="bg-white rounded-lg flex flex-col justify-center md:max-w-[400px]">
        ...
        <div className="p-4 pt-2">
          <div className="mb-3">
            <a
              href={event.url}
              className="text-neutral-900 font-semibold  text-lg mb-2 hover:text-indigo-800 inline-block"
            >
             {event.title}
            </a>
            <p className="text-gray-700 text-base font-normal  leading-7 pb-4">
